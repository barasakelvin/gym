...
<html lang="en">
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">KELVIN FITNESS</a>
        </div>
 ...
 echo '<form class="navbar-form navbar-right" role="form" action="include/logout.php">
    ...
    <h4><center>“Life is all about living healthily.”</center></h4>
...
» 	Health Bar ( Serving Protein Shakes, Fat Burners & other Nutrition )<br>
    ...
    <h6>Here are some of our videos</h6>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/HmXMnHlN96o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope;
